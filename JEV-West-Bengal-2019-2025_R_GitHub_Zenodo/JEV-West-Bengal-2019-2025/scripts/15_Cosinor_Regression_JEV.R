...
# ============================================================
# IMPORTANT:
# Replace this section with your actual verified monthly
# dataset if it is stored separately.
#
# Required columns:
# Year
# Month
...
# Check total positive cases

total_positive <- sum(
  monthly_data$Positive
)
...
if (
  any(
    is.na(monthly_data$Year) |
    is.na(monthly_data$Month) |
    is.na(monthly_data$Positive)
  )
) {

  stop(
    "Missing values detected in Year, Month, or Positive."
  )
...
stopifnot(
  all(monthly_data$Month %in% 1:12)
)
...
# ============================================================
#
# Monthly JEV-positive cases are count data.
# Therefore, Poisson harmonic regression is used
# as the primary count-data model.
#
# ============================================================
...
# Extract likelihood-ratio statistics

poisson_LR_chisq <-
  poisson_LRT$Deviance[2]

poisson_LR_df <-
  poisson_LRT$Df[2]

poisson_LR_p <-
  poisson_LRT$`Pr(>Chi)`[2]
...
acf(
  ...
  main = "ACF of Poisson Cosinor Residuals"
...
pacf(
  ...
  main = "PACF of Poisson Cosinor Residuals"
...
# ============================================================
# 26. PUBLICATION-QUALITY COSINOR FIGURE
# ============================================================
...
write.csv(
  ...
  "JEV_Poisson_Cosinor_Results.csv",
...
write.csv(
  ...
  "JEV_Cosinor_Predicted_Values.csv",
...
ggsave(
  ...
  "JEV_Poisson_Cosinor_Seasonality.png",
...
cat(
  "Study period: January 2019 – December 2025\n"
)
